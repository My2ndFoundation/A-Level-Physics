...
```mermaid
flowchart LR
    A["Galaxy receding<br/>with speed v"] --> B["Light wavelength stretched<br/>λ_obs > λ_emitted"]
    B --> C["Redshift z = Δλ/λ<br/>For v≪c: z ≈ v/c"]
    C --> D["Greater z → greater recession speed"]
    D --> E["Hubble's Law:<br/>v = H₀ d<br/>distance ∝ recession speed"]
    E --> F["Evidence for expanding Universe<br/>→ Big Bang Theory"]
```
