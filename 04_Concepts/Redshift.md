...
Symbols: λ_emitted = laboratory wavelength of a spectral line (m),
λ_observed = measured wavelength (m), v = recession speed (m s⁻¹),
c = 3.00 × 10⁸ m s⁻¹. Redshift is dimensionless. A negative value (blueshift)
indicates approach.
