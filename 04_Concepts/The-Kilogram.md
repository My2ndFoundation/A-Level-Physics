...
```mermaid
flowchart LR
    A["1793<br/>Litre of water<br/>at melting ice"] --> B["1799<br/>Kilogramme des Archives<br/>platinum cylinder"]
    B --> C["1889<br/>IPK 'Le Grand K'<br/>Pt-Ir cylinder, BIPM"]
    C --> D["1889-2014<br/>IPK drifts vs copies<br/>~50 μg per century"]
    D --> E["2019<br/>Planck constant<br/>h = 6.62607015e-34 J s fixed"]
```
