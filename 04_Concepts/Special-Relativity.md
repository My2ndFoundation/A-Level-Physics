...
```mermaid
flowchart TD
    P1[Postulate 1<br/>Laws of physics<br/>same in all inertial frames]
    P2[Postulate 2<br/>Speed of light c<br/>same for all observers]
    P1 --> C1[Relativity of simultaneity]
    P2 --> C1
    P1 --> C2[Time dilation]
    P2 --> C2
    P1 --> C3[Length contraction]
    P2 --> C3
    P1 --> C4[Mass-energy equivalence]
    P2 --> C4
```
...
![[_attachments/04_Concepts/Special-Relativity--wiki-einstein-1921.jpg]]
