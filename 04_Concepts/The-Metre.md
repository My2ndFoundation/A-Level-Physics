...
```mermaid
flowchart LR
    A["1791<br/>Earth's meridian<br/>1/10,000,000 quarter"] --> B["1799<br/>Mètre des Archives<br/>platinum bar"]
    B --> C["1889<br/>International Prototype<br/>Pt-Ir X-section bar"]
    C --> D["1960<br/>Krypton-86<br/>1,650,763.73 wavelengths"]
    D --> E["1983<br/>Speed of light<br/>1/299,792,458 s of c"]
    E --> F["2019<br/>SI revision<br/>same value, fixed c"]
```
