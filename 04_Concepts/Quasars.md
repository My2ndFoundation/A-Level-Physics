...
```mermaid
flowchart TD
  A["Host galaxy<br/>(faint, extended)"] --> B["Supermassive black hole<br/>at centre"]
  B --> C["Accretion disc<br/>(hot gas spiraling in)"]
  C --> D["Enormous luminosity<br/>across radio → X-ray"]
  C --> E["Large redshift z<br/>from Hubble flow"]
```
