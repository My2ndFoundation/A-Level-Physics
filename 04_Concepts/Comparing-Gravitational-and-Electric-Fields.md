...
| Force law | F = Gm₁m₂ / r² | F = (1/4πε₀) Q₁Q₂ / r² ([[Coulombs-Law]]) |
| Field strength | g = F/m | E = F/Q ([[Electric-Field-Strength]]) |
| Potential | V_g = −GM/r | V = (1/4πε₀) Q/r ([[Electric-Potential]]) |
| Potential energy | E_p = −GMm/r | E_p = (1/4πε₀) Qq/r ([[Electric-Potential-Energy]]) |
| Constant | G (very small) | 1/4πε₀ (very large) |
...
- Using 1/r for force or 1/r² for potential (force ∝ 1/r², potential ∝ 1/r in both fields).
