...
```mermaid
flowchart TD
  A["Massive star core collapse"] --> B{"Remnant mass?"}
  B -- "< ~1.4 M_☉" --> C["White dwarf<br/>(not a supernova route)"]
  B -- "1.4 – ~3 M_☉" --> D["Neutron star<br/>R ≈ 10 km"]
  B -- "> ~3 M_☉" --> E["Black hole<br/>event horizon at R_s = 2GM/c²"]
```
