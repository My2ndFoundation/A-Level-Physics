...
3. Apply [[Snell-Law]]: *n₁ sinθ₁ = n₂ sinθ₂*.
...
6. For total internal reflection (going to a less dense medium), find the critical angle from *sinθ_c = n₂/n₁*.

## Worked Example

Light passes from air (*n₁ = 1.00*) into glass (*n₂ = 1.50*) at 40° to the normal. Then 1.00 × sin40° = 1.50 × sinθ₂, so sinθ₂ = 0.643 / 1.50 = 0.429, giving θ₂ ≈ 25°. The ray bends toward the normal on entering the denser medium, as expected.
