...
status: usable
aliases:
  - photoelectric equation method
  - Einstein photoelectric calculation
sources: []
---
...
Use it for any photoelectric effect calculation: threshold frequency, maximum electron speed/energy, work function determination, or interpreting a stopping-voltage versus frequency graph.
...
By the [[Photon-Model]], one photon gives all its energy *hf* to one electron. Energy *φ* is spent escaping the metal; whatever remains becomes the electron's maximum kinetic energy — a direct statement of energy conservation.
...
- Threshold-frequency and stopping-potential problems
